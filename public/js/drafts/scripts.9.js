...
function articles(marker, query) 
{
    ...
    // retrieve weather from openweathermap using my own API (be sure to allow unsecure scripts if running on https, https required paid subscription)
    $.getJSON("http://api.openweathermap.org/data/2.5/weather?zip=" + query + ",us&mode=json&appid=3ec90c1c831270ac6dcf9dc52aa5e503",function(result){
