...
function addMarker(place)
{
    ...
    if(patternmatches) {
        info.setContent(html.join("\n"));
    }
    
    // no articles loaded
    else {
        info.setContent("Slow news day");
    }
    });
